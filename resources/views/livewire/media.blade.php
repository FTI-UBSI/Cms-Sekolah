<div>
  ...
  <div>
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-2 mx-20 mt-4 mb-4">
        ...
        <div class="h-72 border-4 rounded-lg text-center transform transition-transform duration-300 hover:scale-95">
          
          {{-- {!! App\Helpers\InstagramHelper::getEmbed($post->url) !!} --}}
          <a href="{{ $gram->Instagram_url }}" target="_blank">
            <img src="{{ asset('storage/'.$gram->gamabrinstagram_cover)}}" alt="Postingan Instagram" class="h-72 w-full"></img>
          </a>
  ...
  <div>
    ...
    <div class="h-72 border-4 rounded-lg text-center transform transition-transform duration-300 hover:scale-95">
      ...
      {{-- {!! App\Helpers\InstagramHelper::getEmbed($post->url) !!} --}}
      <a href="{{ $gram->Facebook_url }}" target="_blank">
        <img src="{{ asset('storage/'.$gram->gamabrfacebook_cover)}}" alt="Postingan Instagram" class="h-72 w-full"></img>
      </a>
