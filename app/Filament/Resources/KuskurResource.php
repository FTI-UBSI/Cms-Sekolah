...
use App\Filament\Resources\KuskurResource\Pages;
use App\Filament\Resources\KuskurResource\RelationManagers;
...
class KuskurResource extends Resource
{
    protected static ?string $model = Kuskur::class;
...
public static function table(Table $table): Table
{
    ...
    {
        return [
            'index' => Pages\ListKuskurs::route('/'),
            'create' => Pages\CreateKuskur::route('/create'),
            'edit' => Pages\EditKuskur::route('/{record}/edit'),
        ];
    }
}
