...
use App\Filament\Resources\SyaratppdbResource\Pages;
use App\Filament\Resources\SyaratppdbResource\RelationManagers;
...
class SyaratppdbResource extends Resource
{
    protected static ?string $model = Syaratppdb::class;
    ...
    {
        return [
            'index' => Pages\ListSyaratppdbs::route('/'),
            'create' => Pages\CreateSyaratppdb::route('/create'),
            'edit' => Pages\EditSyaratppdb::route('/{record}/edit'),
        ];
    }
}
